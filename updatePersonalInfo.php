...
echo <<<_END
<form action="updatePersonalInfo.php" method="post"<pre>
	...
	Driver Type <input type="text" name="Driver_Type"></br></br>
	
	<input type="submit" name="UPDATE PERSONAL INFO">
	</br></br>
	...
	<a href="makeviolationpayment (1).php" >Pay Violation</a>
</pre></form>
_END;
